...
public class FileDiffApplierTests
{
    ...
    public void Apply_FileAdd_ToEmpty()
    {
        ...
        var newFa = new FileAnalysis { File = "a.cs", Lines = new List<LineGroup> {
            LG(LineType.Code, 5), LG(LineType.Comment, 2)
        } };
    ...
    {
        var oldFa = new FileAnalysis { File = "a.cs", Lines = new List<LineGroup> { LG(LineType.Code, 3) } };
        var newFa = new FileAnalysis { File = "a.cs", Lines = new List<LineGroup> { LG(LineType.Code, 5) } };
